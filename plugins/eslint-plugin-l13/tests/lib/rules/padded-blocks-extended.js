/**
 * @fileoverview Tests for padded-blocks-extended rule.
...
const rule = require("../../../lib/rules/padded-blocks-extended"),
...
ruleTester.run("padded-blocks-extended", rule, {
    valid: [
        "{\n\na();\n\n}",
        "{\n\n\na();\n\n\n}",
        "{\n\n//comment\na();\n\n}",
    ...
    invalid: [
        ...
        },
        {
            code: "class A {\n\nconstructor(){\n\nfoo();\n\n}\n\n}",
            output: "class A {\nconstructor(){\nfoo();\n}\n}",
            options: [{ functions: "never", classes: "never" }],
            parserOptions: { ecmaVersion: 6 },
            errors: [
                {
                    messageId: "neverPadBlock",
