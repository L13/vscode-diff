...
module.exports = {
    ...
    create(context) {
        ...
        if (typeof typeOptions === "string") {
            ...
            options.functions = shouldHavePadding;
        } else {
            ...
            if (Object.prototype.hasOwnProperty.call(typeOptions, "functions")) {
                options.functions = typeOptions.functions === "always";
            }
        }
         ...
         */
        function requirePaddingFor(node, isFuncBlockNode) {
         ...
         */
        function checkPadding(node, isFuncBlockNode = false) {
            ...
            if (requirePaddingFor(node, isFuncBlockNode)) {
        ...
        if (Object.prototype.hasOwnProperty.call(options, "blocks")) {
			...
			// DoWhileStatement > BlockStatement
			// // Conditions
            ...
            rule[':not(ArrowFunctionExpression):not(FunctionDeclaration):not(FunctionExpression) > BlockStatement'] = function(node) {
        ...
        if (Object.prototype.hasOwnProperty.call(options, "functions")) {
            rule[':matches(ArrowFunctionExpression, FunctionDeclaration, FunctionExpression) > BlockStatement'] = function(node) {
                if (node.body.length === 0) {
                    return;
                }
                checkPadding(node, true);
            };
        }
