...
export default {
	...
	"l13-diff-folders/l13-diff-folders.html": "<slot></slot>",
	...
	"l13-diff-swap/l13-diff-swap.html": "<button (click)=\"change()\" [disabled]=\"disabled\"></button>",
	"l13-diff-tools/l13-diff-tools.html": "<slot></slot>",
